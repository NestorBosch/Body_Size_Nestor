...
work.dir=("~/workspace/Body_Size_Nestor") #for ecocloud server
# or
...
dat <- gs_title("length.analysis")%>% #select the gsheet
  gs_read_csv()%>% #select the worksheet within the workbook
  glimpse()
